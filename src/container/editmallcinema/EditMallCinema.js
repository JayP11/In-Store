...
const EditMallCinema = ({
  ...
  const { UpdateMallStore, UpdateCinemaStore } = useMallContext();
      ...
      <div className="mm_main_wrapp">
        ...
        <div className="mm_form_wrapp mm_form_wrapp_add_brand_mall mm_form_wrapp_padding">
          ...
          <div className="mm_form_input_wrapp">
            ...
            {retailerType == 2 ? <>
              <div className="mm_form_single_input">
                <label htmlFor="" className="" style={{ minWidth: "166px" }}>Select Brands<span className="star_require">*</span></label>
          ...
          <div className="brand-add-img-flex">
            ...
            <p className="upload_img_instr">All Cinema logo’s to be uploaded <br />
