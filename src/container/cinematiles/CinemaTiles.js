...
import { CinemaHero, CinemaTilesCard, ProductTilesCard, RetailerNavigationBar } from '../../components'
...
const CinemaTiles = ({ get_mall_auth_data, setTab, getTab }) => {
            ...
            {loading === true ? (
                ...
                <div className="mm_main_wrapp">
                    <div className="leaderboard-sub-wrapp">
                        ...
                        <p className='cinematiles-head-desc'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam.
                        </p>
                        <div className="mm_horizontal_line"></div>
                        {/* LeaderBoard  name end */}

                        {/* Leaderboard Filter Start */}
                        <div className="leaderboard-filter-main-wrapp" style={{marginBottom:"2rem"}}>
