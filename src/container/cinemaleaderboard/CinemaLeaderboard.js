...
const CinemaLeaderboard = ({ get_mall_auth_data, setTab, gettab }) => {
    ...
    <div>
      {loading === true ? (
        ...
        <div className="mm_main_wrapp">
          ...
          <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 35 ? "Leaderboard Banner Mall" : ""} />
            ...
            >
              <div className="leaderboard-inner-namebox">
                ...
                <span className="leaderboard-span" style={{ fontWeight: "600" }}>Leaderboard Banners</span>
              </div>
