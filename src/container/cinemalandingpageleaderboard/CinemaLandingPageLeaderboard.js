...
const CinemaLandingPageLeaderboard = ({ get_mall_auth_data, setTab, getTab,gettab }) => {
  ...
  useEffect(() => {
    ...
    getCategoryApi();
    getWeekApi();
    console.log("main name is",get_mall_auth_data);
          ...
          <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 42 ? "Landing Page Leaderboard Banner" : ""} />
            ...
            >
              <div className="leaderboard-inner-namebox">
                ...
                <span className="leaderboard-span" style={{ fontWeight: "600" }}>Landing Page Leaderboard</span>
              </div>
