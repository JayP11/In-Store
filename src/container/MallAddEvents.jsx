    ...
    <>
      ...
      <div className="mm_main_wrapp mm_form_wrapp_add_brand_mall">
        ...
        <div className="mall_name_wrapp mm_form_wrapp_name_padding">
          ...
          <span style={{ fontWeight: "700" }}>Add Events</span>
        </div>
        ...
        <div className="mm_form_wrapp mm_form_wrapp_add_brand_mall mm_form_wrapp_padding">
          ...
          <div className="mm_form_input_wrapp">
            ...
            <div className="mm_form_single_input">
              <label htmlFor="ename" style={{ minWidth: "145px" }}>
                Event Name
              </label>
              <input
                type="text"
            ...
            {/* single text-input */}
            <div className="mm_form_single_input">
              <label htmlFor="elocation" style={{ minWidth: "145px" }}>
                Event Location
              </label>
              <input
                type="text"
            ...
            <div className="mm_form_single_input">
              <label htmlFor="" style={{ minWidth: "145px" }}>
                Event Date
              </label>
              {/* <input
              type="date"
            ...
            <div className="mm_form_single_input brand-resp-btn">
              <label htmlFor="" style={{ minWidth: "145px" }}></label>
              <button
        ...
        <div className="mm_form_single_input mb_8">
          <label htmlFor=""></label>
          <div
            className="signup_terms_wrapp indep-side-show indep-side-show-event"
            style={{ marginTop: "-12px" }}>
            <input
              type="checkbox"
              onChange={(e) => (
