...
const CinemaHero = ({ get_mall_auth_data }) => {
  return (
    <div className="mall_hero_main_wrapp">
      <img
        // src={get_mall_auth_data ? get_mall_auth_data.banner_mall_path : images.cinema_banner}
      ...
      <div className="mall_hero_logo_wrapp">
        <img 
        // src={get_mall_auth_data ? get_mall_auth_data.shopping_center_logo_mall_path : images.cinema_logo} 
